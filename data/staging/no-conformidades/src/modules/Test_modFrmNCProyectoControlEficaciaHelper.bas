Attribute VB_Name = "Test_modFrmNCProyectoControlEficaciaHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCProyectoControlEficaciaHelper (slice 9 of form-thin-helper-refactor).
'
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    result = modFrmNCProyectoControlEficaciaHelper_RenderError( _
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Happy_NoModal_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Sad_WarningPath_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Edge_EmptyText_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoControlEficaciaHelper_RenderError_Adversarial_VeryLongText_Atomic = _
