...
' -----------------------------------------------------------------------------
' Placeholder para que BootstrapEstadoCatalogo compile (SDD: cache-idempotent-warmup-2026-06-17).
' El cache-warmup del catalogo ya esta cubierto por
' ModuloCacheWarmupWrapper.Warmup_EstadoCatalogo; este entry point queda
' para backward-compat y para no romper el flujo de BootstrapEstadoCatalogo.
' Si en el futuro se necesita un warmup de catalogo con logica propia, mover
' la implementacion de Warmup_EstadoCatalogo aca.
' -----------------------------------------------------------------------------
