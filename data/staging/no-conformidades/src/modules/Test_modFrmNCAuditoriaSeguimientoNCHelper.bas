Attribute VB_Name = "Test_modFrmNCAuditoriaSeguimientoNCHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCAuditoriaSeguimientoNCHelper (slice 8 of form-thin-helper-refactor).
'
...
'           inline in Form_FormNCAuditoriaSeguimientoNC.cls:
'             1. _RenderError  -- boilerplate error handler (6 errores: blocks, 12 MsgBox)
' Slice:    8 of 25 (SeguimientoNC pair -- NCAuditoria side).
'           4 atoms total (1 public function x 4 scenario classes: happy/sad/edge/adversarial).
'
' Source-of-truth provenance:
'   - Form_FormNCAuditoriaSeguimientoNC.cls -- 6 MsgBox-having errores: blocks confirmed
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    result = modFrmNCAuditoriaSeguimientoNCHelper_RenderError( _
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Happy_NoModal_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Sad_WarningPath_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Edge_EmptyText_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoNCHelper_RenderError_Adversarial_VeryLongText_Atomic = _
