Attribute VB_Name = "Test_modFrmNCProyectoSeguimientoNCHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCProyectoSeguimientoNCHelper (slice 8 of form-thin-helper-refactor).
'
...
'           inline in Form_FormNCProyectoSeguimientoNC.cls:
'             1. _RenderError  -- boilerplate error handler (9 errores: blocks, 18 MsgBox)
' Slice:    8 of 25 (SeguimientoNC pair -- NCProyecto side).
'           4 atoms total (1 public function x 4 scenario classes: happy/sad/edge/adversarial).
'
' Source-of-truth provenance:
'   - Form_FormNCProyectoSeguimientoNC.cls -- 9 MsgBox-having errores: blocks confirmed
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    result = modFrmNCProyectoSeguimientoNCHelper_RenderError( _
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Happy_NoModal_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Sad_WarningPath_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Edge_EmptyText_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoNCHelper_RenderError_Adversarial_VeryLongText_Atomic = _
