Attribute VB_Name = "Test_modFrmNCAuditoriaControlEficaciaHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCAuditoriaControlEficaciaHelper (slice 9 of form-thin-helper-refactor).
'
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    result = modFrmNCAuditoriaControlEficaciaHelper_RenderError( _
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Happy_NoModal_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Sad_WarningPath_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Edge_EmptyText_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaHelper_RenderError_Adversarial_VeryLongText_Atomic = _
