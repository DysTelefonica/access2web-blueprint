Attribute VB_Name = "Test_modFrmNCProyectoARHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCProyectoARHelper (slice 5 of form-thin-helper-refactor).
'
...
'           inline in Form_FormNCProyectoAR.cls:
...
' Slice:    5 of 27 (AR pair: NCProyectoAR; NCAuditoriaAR = 5b).
...
Private Const MSG_MOTIVO_PROMPT As String = "MSG-AR-MOTIVO: Introduzca el motivo para marcar como borrada la no conformidad"
...
' path. Mirrors Test_modFrmNCProyectoAccionesHelper.bas: EnsureNCProyectoFixtureForSlice3
' but uses FIX_ID_NC in the 900650001 range (slice 5 range, distinct from slice 3's
' 900640001).
Private Function EnsureNCProyectoFixtureForSlice5(ByVal p_Db As DAO.Database, _
                                                   ByVal p_IDNC As Long, _
                                                   ByVal p_Codigo As String, _
                                                   ByVal p_Borrado As Boolean, _
                                                   ByRef p_Error As String) As Boolean
    On Error GoTo EH
    EnsureNCProyectoFixtureForSlice5 = False
    p_Error = ""
    ...
    p_Db.Execute "INSERT INTO TbNoConformidades (IDNoConformidad, CodigoNoConformidad, " & _
                 ...
                 "'" & Replace(p_Codigo, "'", "''") & "', " & _
                 "'TEST-EXP-SLICE5', " & _
                 "'NC fixture slice 5 AR', " & _
                 "'REGISTRADA', #2026-06-26#, True, " & _
                 "0, 'TEST-EXP-SLICE5', 'TEST-NEMOT-SLICE5', '', '', " & _
                 "0, 'TEST', 'TEST-ENT-SLICE5', 'TEST-CAUSA-SLICE5', " & _
                 "'TEST_RESPONSABLE_CALIDAD_SLICE5', 'TEST_HOTFIX_USER_SLICE5', " & _
                 "'No', NULL, " & _
                 IIf(p_Borrado, "True", "False") & ", " & _
                 IIf(p_Borrado, "'motivo fixture slice 5'", "NULL") & ", " & _
                 "'')", dbFailOnError
    EnsureNCProyectoFixtureForSlice5 = True
    Exit Function
EH:
    p_Error = "EnsureNCProyectoFixtureForSlice5: " & Err.Description
End Function
...
Private Function BuildNCProyectoForSlice5(ByVal p_IDNC As Long, _
                                          ByVal p_Borrado As Boolean, _
                                          ByVal p_MotivoBorrado As String) As NCProyecto
    Dim nc As NCProyecto
    Set nc = New NCProyecto
    nc.IDNoConformidad = CStr(p_IDNC)
    nc.CodigoNoConformidad = "TEST-COD-SLICE5-" & p_IDNC
    nc.Descripcion = "NC fixture slice 5 AR " & p_IDNC
    nc.CausaYAnalisRaiz = "TEST-CAUSA-SLICE5"
    nc.IDTipo = "1"
    nc.EntidadResponsable = "TEST-ENT-SLICE5"
    ...
    Set BuildNCProyectoForSlice5 = nc
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    returnCode = modFrmNCProyectoARHelper_RenderError( _
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoARHelper_RenderError_Happy_NoModal_Atomic = _
...
EH:
    Test_modFrmNCProyectoARHelper_RenderError_Happy_NoModal_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_RenderError_Happy_NoModal_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    Dim promptResult As Long
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoARHelper_RenderError_Sad_WarningPath_Atomic = _
...
EH:
    Test_modFrmNCProyectoARHelper_RenderError_Sad_WarningPath_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_RenderError_Sad_WarningPath_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    Dim promptResult As Long
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoARHelper_RenderError_Edge_EmptyText_Atomic = _
...
EH:
    Test_modFrmNCProyectoARHelper_RenderError_Edge_EmptyText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_RenderError_Edge_EmptyText_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    Dim promptResult As Long
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoARHelper_RenderError_Adversarial_VeryLongText_Atomic = _
...
EH:
    Test_modFrmNCProyectoARHelper_RenderError_Adversarial_VeryLongText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_RenderError_Adversarial_VeryLongText_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic() As String
    Dim logs As Collection
    ...
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext

    Set ncParaBorrar = BuildNCProyectoForSlice5(FIX_ID_NC, False, "")
    promptResult = -1  ' atom mode
    motivo = ""

    jsonResult = modFrmNCProyectoARHelper_ConfirmarBorradoNC( _
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim motivo As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim motivo As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim motivo As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
'   Atom asserts the helper returns the prompt-text contract via JSON value.
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext

    Set ncParaHabilitar = BuildNCProyectoForSlice5(FIX_ID_NC, True, "motivo fixture")
    promptResult = -1  ' atom mode

    jsonResult = modFrmNCProyectoARHelper_ConfirmarHabilitacionNC( _
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim ncParaHabilitar As NCProyecto
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext

    Set ncNoBorrada = BuildNCProyectoForSlice5(FIX_ID_NC, False, "")  ' NOT borrada
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim helperErrMsg As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoARHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function