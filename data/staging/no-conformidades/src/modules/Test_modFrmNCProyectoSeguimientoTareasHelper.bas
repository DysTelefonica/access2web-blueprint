Attribute VB_Name = "Test_modFrmNCProyectoSeguimientoTareasHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCProyectoSeguimientoTareasHelper (slice 7 of form-thin-helper-refactor).
'
...
'           inline in Form_FormNCProyectoSeguimientoTareas.cls:
'             1. _RenderError  -- boilerplate error handler (10 errores: blocks, 20 MsgBox)
' Slice:    7 of 25 (SeguimientoTareas pair -- NCProyecto side).
'           4 atoms total (1 public function x 4 scenario classes: happy/sad/edge/adversarial).
'
' Source-of-truth provenance:
'   - Form_FormNCProyectoSeguimientoTareas.cls -- 10 errores: blocks confirmed
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    result = modFrmNCProyectoSeguimientoTareasHelper_RenderError( _
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Happy_NoModal_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Sad_WarningPath_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Edge_EmptyText_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCProyectoSeguimientoTareasHelper_RenderError_Adversarial_VeryLongText_Atomic = _
