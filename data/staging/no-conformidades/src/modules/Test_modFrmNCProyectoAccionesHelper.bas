Attribute VB_Name = "Test_modFrmNCProyectoAccionesHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCProyectoAccionesHelper (slice 3 of form-thin-helper-refactor).
'
...
'           inline in Form_FormNCProyectoAcciones.cls:
'             1. _RenderError          -- boilerplate error handler (~50 of 54 MsgBox)
...
' Slice:    3 of 27 (Acciones pair: NCProyectoAcciones; NCAuditoriaAcciones = 3b).
' =============================================================================

' ----- Message contract (byte-for-byte match with production literals) -----
Private Const MSG_BORRADO_PROMPT As String = "MSG-ACCIONES-BORRADO: ¿Desea borrar la Acción Correctiva seleccionada?"
Private Const MSG_HABILITACION_PROMPT As String = "MSG-ACCIONES-HABILITACION: ¿Desea habilitar la no conformidad de proyecto seleccionada?"
Private Const MSG_MOTIVO_PROMPT As String = "MSG-ACCIONES-MOTIVO: Introduzca el motivo para marcar como borrada la no conformidad"
...
Private Const FIX_ID_NC As Long = 900640001
...
' path. Mirrors Test_modFrmNCProyectoGestionHelper.bas: EnsureNCProyectoFixtureForSlice2a
' but uses FIX_ID_NC in the 900640001 range (slice 3 range, distinct from slice 2a's
' 900620001).
Private Function EnsureNCProyectoFixtureForSlice3(ByVal p_Db As DAO.Database, _
                                                   ByVal p_IDNC As Long, _
                                                   ByVal p_Codigo As String, _
                                                   ByVal p_Borrado As Boolean, _
                                                   ByRef p_Error As String) As Boolean
    On Error GoTo EH
    EnsureNCProyectoFixtureForSlice3 = False
    p_Error = ""
    ...
    p_Db.Execute "INSERT INTO TbNoConformidades (IDNoConformidad, CodigoNoConformidad, " & _
                 ...
                 "'" & Replace(p_Codigo, "'", "''") & "', " & _
                 "'TEST-EXP-SLICE3', " & _
                 "'NC fixture slice 3 acciones', " & _
                 "'REGISTRADA', #2026-06-26#, True, " & _
                 "0, 'TEST-EXP-SLICE3', 'TEST-NEMOT-SLICE3', '', '', " & _
                 "0, 'TEST', 'TEST-ENT-SLICE3', 'TEST-CAUSA-SLICE3', " & _
                 "'TEST_RESPONSABLE_CALIDAD_SLICE3', 'TEST_HOTFIX_USER_SLICE3', " & _
                 "'No', NULL, " & _
                 IIf(p_Borrado, "True", "False") & ", " & _
                 IIf(p_Borrado, "'motivo fixture slice 3'", "NULL") & ", " & _
                 "'')", dbFailOnError
    EnsureNCProyectoFixtureForSlice3 = True
    Exit Function
EH:
    p_Error = "EnsureNCProyectoFixtureForSlice3: " & Err.Description
End Function
...
Private Function BuildNCProyectoForSlice3(ByVal p_IDNC As Long, _
                                          ByVal p_Borrado As Boolean, _
                                          ByVal p_MotivoBorrado As String) As NCProyecto
    Dim nc As NCProyecto
    Set nc = New NCProyecto
    nc.IDNoConformidad = CStr(p_IDNC)
    nc.CodigoNoConformidad = "TEST-COD-SLICE3-" & p_IDNC
    nc.Descripcion = "NC fixture slice 3 acciones " & p_IDNC
    nc.CausaYAnalisRaiz = "TEST-CAUSA-SLICE3"
    nc.IDTipo = "1"
    nc.EntidadResponsable = "TEST-ENT-SLICE3"
    ...
    Set BuildNCProyectoForSlice3 = nc
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    returnCode = modFrmNCProyectoAccionesHelper_RenderError( _
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoAccionesHelper_RenderError_Happy_NoModal_Atomic = _
...
EH:
    Test_modFrmNCProyectoAccionesHelper_RenderError_Happy_NoModal_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_RenderError_Happy_NoModal_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    Dim promptResult As Long
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoAccionesHelper_RenderError_Sad_WarningPath_Atomic = _
...
EH:
    Test_modFrmNCProyectoAccionesHelper_RenderError_Sad_WarningPath_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_RenderError_Sad_WarningPath_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    Dim promptResult As Long
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoAccionesHelper_RenderError_Edge_EmptyText_Atomic = _
...
EH:
    Test_modFrmNCProyectoAccionesHelper_RenderError_Edge_EmptyText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_RenderError_Edge_EmptyText_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    Dim promptResult As Long
    ...
    If helperErrMsg <> "" Then
        Test_modFrmNCProyectoAccionesHelper_RenderError_Adversarial_VeryLongText_Atomic = _
...
EH:
    Test_modFrmNCProyectoAccionesHelper_RenderError_Adversarial_VeryLongText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_RenderError_Adversarial_VeryLongText_Atomic: " & Err.Description, logs)
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic() As String
    Dim logs As Collection
    ...
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext

    Set ncParaBorrar = BuildNCProyectoForSlice3(FIX_ID_NC, False, "")
    promptResult = -1  ' atom mode
    motivo = ""

    jsonResult = modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC( _
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Happy_ReturnsPromptText_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim motivo As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Sad_UserRejected_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim motivo As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Edge_EmptyMotivo_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim motivo As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarBorradoNC_Adversarial_NothingNC_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
'   Atom asserts the helper returns the prompt-text contract via JSON value.
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext

    Set ncParaHabilitar = BuildNCProyectoForSlice3(FIX_ID_NC, True, "motivo fixture")
    promptResult = -1  ' atom mode

    jsonResult = modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC( _
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Happy_ReturnsPromptText_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim ncParaHabilitar As NCProyecto
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Sad_UserRejected_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext

    Set ncNoBorrada = BuildNCProyectoForSlice3(FIX_ID_NC, False, "")  ' NOT borrada
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Edge_AlreadyEnabled_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
...
' =============================================================================
Public Function Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic() As String
    Dim logs As Collection
    Dim jsonResult As String
    Dim promptResult As Long
    Dim helperErrMsg As String
    ...
    Set logs = TestHelper.NewLogs()
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic = _
            TestHelper.BuildJsonFail("BeginTestSession failed", logs)
        Exit Function
    End If
    SetupTestContext
...
EH:
    Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmNCProyectoAccionesHelper_ConfirmarHabilitacionNC_Adversarial_NothingNC_Atomic: " & Err.Description, logs)
    Resume Cleanup
End Function
