Attribute VB_Name = "Test_modFrmNCAuditoriaControlEficaciaAltaHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCAuditoriaControlEficaciaAltaHelper (slice 10 of form-thin-helper-refactor).
'
...
'           inline in Form_FormNCAuditoriaControlEficaciaAlta.cls:
'             1. _RenderError  -- boilerplate error handler (2 errores: blocks, 4 MsgBox: 2 in
'                                ComandoGrabar_Click + 2 in Form_Load)
' Slice:    10 of 25 (ControlEficaciaAlta pair -- NCAuditoria side).
'           4 atoms total (1 public function x 4 scenario classes: happy/sad/edge/adversarial).
'
' Source-of-truth provenance:
'   - Form_FormNCAuditoriaControlEficaciaAlta.cls -- 4 MsgBox-having errores: blocks confirmed
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    result = modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError( _
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Happy_NoModal_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Sad_WarningPath_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Edge_EmptyText_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaControlEficaciaAltaHelper_RenderError_Adversarial_VeryLongText_Atomic = _
