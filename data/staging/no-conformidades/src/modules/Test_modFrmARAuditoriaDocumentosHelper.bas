Attribute VB_Name = "Test_modFrmARAuditoriaDocumentosHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmARAuditoriaDocumentosHelper (slice 6b of form-thin-helper-refactor).
'
...
'           inline in Form_FormARAuditoriaDocumentos.cls:
...
' Slice:    6b of 25 (Documentos group -- second batch: AR Auditoria side).
...
' ----- Fixture IDs (>=900662200 reserved for this module, access-vba-tdd §1.7) -----
Private Const FIX_ID_NC As Long = 900662201
Private Const FIX_ID_DOC As Long = 900662202
...
Private Function EnsureNCAuditoriaFixtureForSlice6b(ByVal p_Db As DAO.Database, _
    ...
    p_Db.Execute "INSERT INTO TbNoConformidadesAuditoria (id, DESCRIPCION, ESTADO, FECHAAPERTURA, Tipo) " & _
                 ...
                 "'NC fixture slice 6b AR auditoria documentos', " & _
...
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    returnCode = modFrmARAuditoriaDocumentosHelper_RenderError( _
        "Al btnExaminar_Click se ha producido el error n: 9" & vbNewLine & "Detalle: subscript out of range", _
        9, -1, helperErrMsg)

    If helperErrMsg <> "" Then
        Test_modFrmARAuditoriaDocumentosHelper_RenderError_Happy_NoModal_Atomic = _
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_RenderError_Happy_NoModal_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_RenderError_Happy_NoModal_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 2 - Sad: _RenderError with Err.Number=1000 (warning path).
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    ...
    If helperErrMsg <> "" Then
        Test_modFrmARAuditoriaDocumentosHelper_RenderError_Sad_WarningPath_Atomic = _
            TestHelper.BuildJsonFail("helperErrMsg should be empty (got='" & helperErrMsg & "')", logs)
        Exit Function
    End If
    TestHelper.AddLog logs, "Assert OK: helperErrMsg empty"
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_RenderError_Sad_WarningPath_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_RenderError_Sad_WarningPath_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 3 - Edge: _RenderError with empty m_ErrorText returns -1, no modal.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    ...
    If helperErrMsg <> "" Then
        Test_modFrmARAuditoriaDocumentosHelper_RenderError_Edge_EmptyText_Atomic = _
            TestHelper.BuildJsonFail("helperErrMsg should be empty (got='" & helperErrMsg & "')", logs)
        Exit Function
    End If
    TestHelper.AddLog logs, "Assert OK: helperErrMsg empty"
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_RenderError_Edge_EmptyText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_RenderError_Edge_EmptyText_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 4 - Adversarial: _RenderError with very long error text.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim returnCode As Long
    Dim helperErrMsg As String
    ...
    If helperErrMsg <> "" Then
        Test_modFrmARAuditoriaDocumentosHelper_RenderError_Adversarial_VeryLongText_Atomic = _
            TestHelper.BuildJsonFail("helperErrMsg should be empty (got='" & helperErrMsg & "')", logs)
        Exit Function
    End If
    TestHelper.AddLog logs, "Assert OK: helperErrMsg empty"
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_RenderError_Adversarial_VeryLongText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_RenderError_Adversarial_VeryLongText_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 5 - Happy: _ConfirmarEliminacionDocumento atom mode returns prompt text.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Happy_ReturnsPromptText_Atomic() As String
    Dim logs As Collection
    ...
    resultJson = modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento( _
        doc, Nothing, -1, helperErrMsg)

    If helperErrMsg <> "" Then
        Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Happy_ReturnsPromptText_Atomic = _
            TestHelper.BuildJsonFail("helperErrMsg should be empty (got='" & helperErrMsg & "')", logs)
        Exit Function
    End If
    TestHelper.AddLog logs, "Assert OK: helperErrMsg empty"
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Happy_ReturnsPromptText_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Happy_ReturnsPromptText_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 6 - Sad: _ConfirmarEliminacionDocumento with vbNo returns user_rejected.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Sad_UserRejected_Atomic() As String
    Dim logs As Collection
    Dim resultJson As String
    Dim helperErrMsg As String
    Dim doc As DocumentoAuditoria
    ...
    If helperErrMsg <> "" Then
        Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Sad_UserRejected_Atomic = _
            TestHelper.BuildJsonFail("helperErrMsg should be empty (got='" & helperErrMsg & "')", logs)
        Exit Function
    End If
    TestHelper.AddLog logs, "Assert OK: helperErrMsg empty"
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Sad_UserRejected_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Sad_UserRejected_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 7 - Edge: _ConfirmarEliminacionDocumento with vbYes passes the gate.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Edge_UserConfirms_Atomic() As String
    Dim logs As Collection
    Dim resultJson As String
    Dim helperErrMsg As String
    ...
    If Not TestHelper.BeginTestSession(logs) Then
        Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Edge_UserConfirms_Atomic = _
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Edge_UserConfirms_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Edge_UserConfirms_Atomic: " & Err.Description, logs)
...
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Adversarial_NothingDoc_Atomic() As String
    Dim logs As Collection
    Dim resultJson As String
    Dim helperErrMsg As String
    ...
    If InStr(1, resultJson, "Nothing", vbTextCompare) = 0 Then
        Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Adversarial_NothingDoc_Atomic = _
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Adversarial_NothingDoc_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ConfirmarEliminacionDocumento_Adversarial_NothingDoc_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 9 - Happy: _ValidarNombreDocumento with unique new name returns ok=true.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Happy_UniqueName_Atomic() As String
    Dim logs As Collection
    Dim resultJson As String
    Dim helperErrMsg As String
    ...
    resultJson = modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento( _
        "nuevo_nombre_unico.pdf", docActual, colDocs, -1, helperErrMsg)

    If helperErrMsg <> "" Then
        Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Happy_UniqueName_Atomic = _
            TestHelper.BuildJsonFail("helperErrMsg should be empty (got='" & helperErrMsg & "')", logs)
        Exit Function
    End If
    TestHelper.AddLog logs, "Assert OK: helperErrMsg empty"
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Happy_UniqueName_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Happy_UniqueName_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 10 - Sad: _ValidarNombreDocumento with empty new name returns MSG_NOMBRE_VACIO.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Sad_EmptyName_Atomic() As String
    Dim logs As Collection
    Dim resultJson As String
    Dim helperErrMsg As String
    Dim docActual As DocumentoAuditoria
    ...
    If InStr(1, resultJson, MSG_NOMBRE_VACIO, vbTextCompare) = 0 Then
        Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Sad_EmptyName_Atomic = _
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Sad_EmptyName_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Sad_EmptyName_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 11 - Edge: _ValidarNombreDocumento with same-as-current returns MSG_NOMBRE_IGUAL.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Edge_SameName_Atomic() As String
    Dim logs As Collection
    Dim resultJson As String
    Dim helperErrMsg As String
    Dim docActual As DocumentoAuditoria
    ...
    If InStr(1, resultJson, MSG_NOMBRE_IGUAL, vbTextCompare) = 0 Then
        Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Edge_SameName_Atomic = _
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Edge_SameName_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Edge_SameName_Atomic: " & Err.Description, logs)
End Function

' =============================================================================
' ATOM 12 - Adversarial: _ValidarNombreDocumento with duplicate in collection.
' =============================================================================
Public Function Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Adversarial_DuplicateName_Atomic() As String
    Dim logs As Collection
    Dim resultJson As String
    Dim helperErrMsg As String
    Dim docActual As DocumentoAuditoria
    ...
    If InStr(1, resultJson, MSG_NOMBRE_DUPLICADO, vbTextCompare) = 0 Then
        Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Adversarial_DuplicateName_Atomic = _
...
EH:
    Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Adversarial_DuplicateName_Atomic = _
        TestHelper.BuildJsonFail("Test_modFrmARAuditoriaDocumentosHelper_ValidarNombreDocumento_Adversarial_DuplicateName_Atomic: " & Err.Description, logs)
End Function