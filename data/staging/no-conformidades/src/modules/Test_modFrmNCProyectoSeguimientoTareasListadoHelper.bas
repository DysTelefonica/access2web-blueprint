Attribute VB_Name = "Test_modFrmNCProyectoSeguimientoTareasListadoHelper"
...
Public Function Test_TareasForm_Delegates_FilterPaths() As String
    ...
    Set result = modFrmNCProyectoSeguimientoTareasListadoHelper.TestHook_SeguimientoTareasFormDelegationPath("Filtrar", "", "", "ACTIVA", "", errMsg)
    If errMsg <> "" Then Err.Raise 1000, , errMsg
    ...
    Set result = modFrmNCProyectoSeguimientoTareasListadoHelper.TestHook_SeguimientoTareasFormDelegationPath("Form_Load", "", "", "ACTIVA", "", errMsg)
    If errMsg <> "" Then Err.Raise 1000, , errMsg
    If Not AssertHelperDelegationCapture(2, "", "", "ACTIVA", "", "Form_Load", assertError) Then GoTo Fail

    Set result = modFrmNCProyectoSeguimientoTareasListadoHelper.TestHook_SeguimientoTareasFormDelegationPath("ComandoLimpiarEstado", "", "", "", "", errMsg)
    If errMsg <> "" Then Err.Raise 1000, , errMsg
    If Not AssertHelperDelegationCapture(3, "", "", "", "", "ComandoLimpiarEstado", assertError) Then GoTo Fail

    Set result = modFrmNCProyectoSeguimientoTareasListadoHelper.TestHook_SeguimientoTareasFormDelegationPath("ComandoLimpiarIDExpediente", "", "", "ACTIVA", "", errMsg)
    If errMsg <> "" Then Err.Raise 1000, , errMsg
    If Not AssertHelperDelegationCapture(4, "", "", "ACTIVA", "", "ComandoLimpiarIDExpediente", assertError) Then GoTo Fail

    Set result = modFrmNCProyectoSeguimientoTareasListadoHelper.TestHook_SeguimientoTareasFormDelegationPath("ComandoLimpiarResposable", "", "", "ACTIVA", "", errMsg)
    If errMsg <> "" Then Err.Raise 1000, , errMsg
    If Not AssertHelperDelegationCapture(5, "", "", "ACTIVA", "", "ComandoLimpiarResposable", assertError) Then GoTo Fail

    Set result = modFrmNCProyectoSeguimientoTareasListadoHelper.TestHook_SeguimientoTareasFormDelegationPath("ComandoLimpiarResposableCalidad", "", "", "ACTIVA", "", errMsg)
    If errMsg <> "" Then Err.Raise 1000, , errMsg
