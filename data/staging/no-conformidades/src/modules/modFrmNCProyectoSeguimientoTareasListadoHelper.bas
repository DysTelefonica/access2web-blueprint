Attribute VB_Name = "modFrmNCProyectoSeguimientoTareasListadoHelper"
...
Public Function TestHook_SeguimientoTareasFormDelegationPath( _
    ...
    If Not m_TestingMode Then
        ...
        Exit Function
    End If
    If Not modSeguimientoTareasHydration.m_TestFormSeguimientoTareasDelegationHookEnabled Then
...
Private Function TryListadoFiltradoSQL( _
    ...
    If m_TestingMode Then
        If modSeguimientoTareasHydration.m_TestTareasHelperCacheErrorSeamEnabled Then
            p_Error = modSeguimientoTareasHydration.m_TestTareasHelperCacheErrorText
...
Private Sub CaptureTestDelegationCall( _
    ...
    If m_TestingMode Then
        If modSeguimientoTareasHydration.m_TestSeguimientoTareasHelperDelegationSeamEnabled Then
            modSeguimientoTareasHydration.m_TestSeguimientoTareasHelperDelegationCallCount = modSeguimientoTareasHydration.m_TestSeguimientoTareasHelperDelegationCallCount + 1
            modSeguimientoTareasHydration.m_TestSeguimientoTareasHelperLastResponsableCalidad = p_ResponsableCalidad
            modSeguimientoTareasHydration.m_TestSeguimientoTareasHelperLastResponsable = p_Responsable
            modSeguimientoTareasHydration.m_TestSeguimientoTareasHelperLastEstado = p_Estado
            modSeguimientoTareasHydration.m_TestSeguimientoTareasHelperLastIDExpediente = p_IDExpediente
        End If
    End If
End Sub
