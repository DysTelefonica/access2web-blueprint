Attribute VB_Name = "Test_modFrmNCAuditoriaSeguimientoTareasHelper"
Option Compare Database
Option Explicit

' =============================================================================
' Atoms for modFrmNCAuditoriaSeguimientoTareasHelper (slice 7 of form-thin-helper-refactor).
'
...
'           inline in Form_FormNCAuditoriaSeguimientoTareas.cls:
'             1. _RenderError  -- boilerplate error handler (6 errores: blocks, 12 MsgBox)
' Slice:    7 of 25 (SeguimientoTareas pair -- NCAuditoria side).
'           4 atoms total (1 public function x 4 scenario classes: happy/sad/edge/adversarial).
'
' Source-of-truth provenance:
'   - Form_FormNCAuditoriaSeguimientoTareas.cls -- 6 errores: blocks confirmed
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Happy_NoModal_Atomic() As String
    ...
    result = modFrmNCAuditoriaSeguimientoTareasHelper_RenderError( _
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Happy_NoModal_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Sad_WarningPath_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Sad_WarningPath_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Edge_EmptyText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Edge_EmptyText_Atomic = _
...
' -----------------------------------------------------------------------------
Public Function Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Adversarial_VeryLongText_Atomic() As String
    Dim logs As Collection
    Dim helperErr As String
    Dim result As Long
    ...
    If result <> PROMPT_ATOM Then
        Test_modFrmNCAuditoriaSeguimientoTareasHelper_RenderError_Adversarial_VeryLongText_Atomic = _
