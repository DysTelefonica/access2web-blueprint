...
Public Function Test_CacheFailureSeam_InactiveByDefault() As String
    ...
    Test_CacheFailureSeam_InactiveByDefault = BuildJsonFail("test did not complete", logs)
...
Public Function Test_CacheFailureSeam_ActivatedProducesControlledFailure() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_CacheFailureSeam_ActivatedProducesControlledFailure = BuildJsonFail("test did not complete", logs)
...
Public Function Test_CacheFailureSeam_ResetClearsFailure() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_CacheFailureSeam_ResetClearsFailure = BuildJsonFail("test did not complete", logs)
...
Public Function Test_ActualizarNCsContratistas_RolledBackWhenCallerRollsBack() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_ActualizarNCsContratistas_RolledBackWhenCallerRollsBack = BuildJsonFail("test did not complete", logs)
    ...
    If Not EnsureSandboxBackend(m_Error) Then
        Test_ActualizarNCsContratistas_RolledBackWhenCallerRollsBack = JsonFail("Sandbox guard: " & m_Error)
        Exit Function
    End If
    m_BackendPath = TestOnlyGetTestingBackendURL()
    m_Password = TestOnlyGetPasswordBackend()
...
Public Function Test_ActualizarNCs_UsesCallerTransactionAndRollsBack() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_ActualizarNCs_UsesCallerTransactionAndRollsBack = BuildJsonFail("test did not complete", logs)
    ...
    If Not EnsureSandboxBackend(m_Error) Then
        Test_ActualizarNCs_UsesCallerTransactionAndRollsBack = JsonFail("Sandbox guard: " & m_Error)
        Exit Function
    End If
    m_BackendPath = TestOnlyGetTestingBackendURL()
    m_Password = TestOnlyGetPasswordBackend()
...
Public Function Test_EliminarLugarEjecucion_StandaloneCacheFailureRollsBack() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_EliminarLugarEjecucion_StandaloneCacheFailureRollsBack = BuildJsonFail("test did not complete", logs)
...
Public Function Test_EliminarRAC_StandaloneCacheFailureRollsBack() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_EliminarRAC_StandaloneCacheFailureRollsBack = BuildJsonFail("test did not complete", logs)
...
Public Function Test_CacheFixture_SeedIsIdempotent_ForLugar() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_CacheFixture_SeedIsIdempotent_ForLugar = BuildJsonFail("test did not complete", logs)
...
Public Function Test_CacheFixture_TeardownIsIdempotent_ForRac() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_CacheFixture_TeardownIsIdempotent_ForRac = BuildJsonFail("test did not complete", logs)
