...
' g_OperationCancelled: flag de cancelacion. REFAC-1b: la popup no tiene boton Cancel
' todavia, pero el helper ya respeta este flag. Tests lo setean para abortar el export
' sin abrir la popup. Cierre del form (CerrarPopupProgreso) lo resetea a False.
Public g_OperationCancelled As Boolean
...
Public Function ActualizarExpedienteCompleto(p_Expediente As Expediente, Optional ByRef p_Error As String) As String
    ...
    If m_ObjEntorno.ColExpedientesCompletos Is Nothing Then
        Exit Function
    End If
...
Public Function getWhereBusqueda( _
    ...
    ' REFAC-1a: shim de un release hacia Helper_ExpedienteConsultas.ConstruirWhereBusqueda.
    ' Cleanup en PRUEBA-002 PR-E.
    On Error GoTo errores
    getWhereBusqueda = Helper_ExpedienteConsultas.ConstruirWhereBusqueda(p_ExpBusqueda, p_Error)
    Exit Function
errores:
    If Err.Number <> 1000 Then
...
Public Function getColBusqueda( _
    ...
    ' REFAC-1a: shim de un release hacia Helper_ExpedienteConsultas.CargarColBusqueda.
    ' Cleanup en PRUEBA-002 PR-E.
    On Error GoTo errores
    Set getColBusqueda = Helper_ExpedienteConsultas.CargarColBusqueda(p_ExpBusqueda, _
        p_ParaAM, p_ParaLote, p_ParaBasado, p_ParaExpediente, Nothing, p_Error)
...
Public Function getColBusquedaTecnica( _
    ...
    ' REFAC-1a: shim de un release hacia Helper_ExpedienteConsultas.CargarColBusquedaTecnica.
    ' Cleanup en PRUEBA-002 PR-E.
    On Error GoTo errores
    Set getColBusquedaTecnica = Helper_ExpedienteConsultas.CargarColBusquedaTecnica(p_ExpBusqueda, Nothing, p_Error)
    If p_Error <> "" Then Err.Raise 1000
    Exit Function
errores:
    If Err.Number <> 1000 Then
        p_Error = "El método getColBusquedaTecnica ha devuelto el error: " & Err.Description
    End If
End Function
...
Public Function getExpBusqueda( _
    ...
    With m_ExpBusqueda
        ...
        ElseIf p_Form.MarcoRespSeguridad = 2 Then
            .ResponsableSeguridad = "Natalia González Ordónez"
        ...
        ElseIf p_Form.MarcoCalidad = 6 Then
            .ResponsableCalidad = "Florentina Cuevas Castaño"
        ElseIf p_Form.MarcoCalidad = 7 Then
            .ResponsableCalidad = "Maria Toquero Aparicio"
        Else
...
Public Function setExpBusqueda( _
    ...
    With p_ExpBusqueda
        ...
        ElseIf .ResponsableSeguridad = "Natalia González Ordónez" Then
        ...
        ElseIf .ResponsableCalidad = "Florentina Cuevas Castaño" Then
            p_Form.MarcoCalidad = 6
        ElseIf .ResponsableCalidad = "Maria Toquero Aparicio" Then
            p_Form.MarcoCalidad = 7
        Else
