...
Private Const TEST_EXPEDIENTE_ID_BASE As Long = 920000
Private Const TEST_ORDINAL_E2E_BASE As Long = 920000
Private Const TEST_CANONICAL_LIST_ID_BASE As Long = 921000

Private Function NextE2ETestExpedienteId(ByVal p_db As DAO.Database) As Long
    Static nextId As Long

    If nextId = 0 Then
        nextId = TEST_EXPEDIENTE_ID_BASE
    Else
        nextId = nextId + 1
    End If

    CleanupE2ETestExpediente p_db, nextId

    NextE2ETestExpedienteId = nextId
End Function

Private Function NextE2ETestOrdinal(ByVal p_db As DAO.Database) As Long
    Static nextOrdinal As Long

    If nextOrdinal = 0 Then
        nextOrdinal = TEST_ORDINAL_E2E_BASE
    Else
        nextOrdinal = nextOrdinal + 1
    End If

    NextE2ETestOrdinal = nextOrdinal
End Function

Private Sub CleanupE2ETestExpediente(ByVal p_db As DAO.Database, ByVal p_IDExpediente As Long)
    p_db.Execute "DELETE FROM TbExpedientes WHERE IDExpediente=" & CStr(p_IDExpediente), dbFailOnError
End Sub

Private Sub CleanupCanonicalListFixture(ByVal p_db As DAO.Database, ByVal p_Count As Long)
    Dim i As Long

    For i = 0 To p_Count - 1
        CleanupE2ETestExpediente p_db, TEST_CANONICAL_LIST_ID_BASE + i
    Next i
End Sub

Private Function SeedCanonicalListFixture(ByVal p_db As DAO.Database, ByVal p_Count As Long, ByRef p_Error As String) As String
    On Error GoTo EH

    Dim i As Long
    Dim fixtureId As Long
    Dim csv As String

    If p_Count <= 0 Then p_Count = 3
    CleanupCanonicalListFixture p_db, p_Count

    For i = 0 To p_Count - 1
        fixtureId = TEST_CANONICAL_LIST_ID_BASE + i
        p_db.Execute "INSERT INTO TbExpedientes (IDExpediente, OrdinalE2E, Nemotecnico, Titulo) VALUES (" & _
                     fixtureId & ", " & (TEST_ORDINAL_E2E_BASE + 1000 + i) & ", 'E2E-CANONICAL-" & CStr(i) & "', 'Canonical list fixture " & CStr(i) & "')", dbFailOnError
        csv = csv & IIf(csv = "", "", ",") & CStr(fixtureId)
    Next i

    SeedCanonicalListFixture = csv
    Exit Function

EH:
    p_Error = "canonical list fixture seed failed: " & Err.Description
    On Error Resume Next
    CleanupCanonicalListFixture p_db, p_Count
    SeedCanonicalListFixture = ""
End Function
...
Private Function BuildDeterministicExpedienteIdCsv(ByVal p_db As DAO.Database, ByVal p_TopN As Long, ByRef p_Error As String) As String
    ...
    BuildDeterministicExpedienteIdCsv = SeedCanonicalListFixture(p_db, p_TopN, p_Error)
    Exit Function

EH:
    p_Error = "error seeding deterministic E2E IDs: " & Err.Description
...
Public Function Test_ExpedienteE2EUtils_GetMaxOrdinalE2E_ReturnsHighestIgnoringNull() As String
    Test_ExpedienteE2EUtils_GetMaxOrdinalE2E_ReturnsHighestIgnoringNull = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteE2EUtils_ValidateOrdinalE2EUniqueness_Cases() As String
    Test_ExpedienteE2EUtils_ValidateOrdinalE2EUniqueness_Cases = JsonOK(False, "test did not complete", "")
...
Public Function Test_Constructor_getExpediente_OrdinalE2E_NullDbMapsToNull() As String
    Test_Constructor_getExpediente_OrdinalE2E_NullDbMapsToNull = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_ReturnsMetaAndDataTopLevel() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_ReturnsMetaAndDataTopLevel = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_FiltersOrdinalE2ENullRows() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_FiltersOrdinalE2ENullRows = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_IncludesRequiredScalarKeys() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_IncludesRequiredScalarKeys = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_SerializesNullScalarsAsJsonNull() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_SerializesNullScalarsAsJsonNull = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_MapsScalarValuesWithTypes() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_MapsScalarValuesWithTypes = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_MetaTotalMatchesDataCount() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_MetaTotalMatchesDataCount = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_DefaultGeneratedAtDoesNotError() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_DefaultGeneratedAtDoesNotError = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_DateScalars_NullAsJsonNull() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_DateScalars_NullAsJsonNull = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_DateScalars_FormatDeterministic() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_DateScalars_FormatDeterministic = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_IncludesCanonicalKeys() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_IncludesCanonicalKeys = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_NullAsJsonNull() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_NullAsJsonNull = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_ValueFidelity() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_ValueFidelity = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_OrphanLookupAsJsonNull() As String
    Test_ExpedienteJsonExporter_ExportAllE2E_TextFlagScalars_OrphanLookupAsJsonNull = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_GuardarJsonEnArchivo_WritesUtf8LiteralChars() As String
    Test_ExpedienteJsonExporter_GuardarJsonEnArchivo_WritesUtf8LiteralChars = JsonOK(False, "test did not complete", "")
...
Public Function Test_ExpedienteJsonExporter_GenerarJsonE2ECanonicoPorLista_MetaAndRootContract() As String
    Test_ExpedienteJsonExporter_GenerarJsonE2ECanonicoPorLista_MetaAndRootContract = JsonOK(False, "test did not complete", "")
    ...
    CleanupCanonicalListFixture db, 3
    If p_Error <> "" Then
        Test_ExpedienteJsonExporter_GenerarJsonE2ECanonicoPorLista_MetaAndRootContract = JsonOK(False, p_Error, "")
        Exit Function
    End If
...
HandleError:
    On Error Resume Next
    If Not db Is Nothing Then CleanupCanonicalListFixture db, 3
...
Public Function Test_ExpedienteJsonExporter_GenerarJsonE2ECanonicoPorLista_NestedContractKeys() As String
    Test_ExpedienteJsonExporter_GenerarJsonE2ECanonicoPorLista_NestedContractKeys = JsonOK(False, "test did not complete", "")
