...
Public Function Test_BackendResolver_ResolveValidConfiguredBackend() As String
    ...
    Test_BackendResolver_ResolveValidConfiguredBackend = BuildJsonFail("test did not complete", logs)
...
Public Function Test_BackendResolver_RejectInvalidBackendKey() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_BackendResolver_RejectInvalidBackendKey = BuildJsonFail("test did not complete", logs)
...
Public Function Test_BackendResolver_RejectEmptyBackendKey() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_BackendResolver_RejectEmptyBackendKey = BuildJsonFail("test did not complete", logs)
...
Public Function Test_BackendResolver_RejectEmptyBackendPath() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_BackendResolver_RejectEmptyBackendPath = BuildJsonFail("test did not complete", logs)
...
Public Function Test_BackendResolver_RejectMissingBackendFile() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_BackendResolver_RejectMissingBackendFile = BuildJsonFail("test did not complete", logs)
...
Public Function Test_BackendResolver_NoFallbackToProdWhenKeyInvalid() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_BackendResolver_NoFallbackToProdWhenKeyInvalid = BuildJsonFail("test did not complete", logs)
...
Public Function Test_BackendResolver_AssertSandboxBackend_FailsWhenTestingModeOff() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_BackendResolver_AssertSandboxBackend_FailsWhenTestingModeOff = BuildJsonFail("test did not complete", logs)
...
Public Function Test_BackendResolver_EnsureSandboxBackend_ConfiguresSandbox() As String
    Dim logs(0 To 0) As String
    ' Default: fail. Solo se override si los asserts pasan.
    Test_BackendResolver_EnsureSandboxBackend_ConfiguresSandbox = BuildJsonFail("test did not complete", logs)
