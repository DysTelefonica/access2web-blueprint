...
Public Function Test_E2EHashService_HashIgnoresRootMeta() As String
...
Public Function Test_E2EHashService_HashChangesWhenSignificantFieldChanges() As String
    Dim p_Error As String
    Dim jsonA As String
    Dim jsonB As String
    Dim hashA As String
...
Public Function Test_E2EHashService_HashIgnoresTechnicalFields() As String
    Dim p_Error As String
    Dim jsonA As String
    Dim jsonB As String
    Dim hashA As String
...
Public Function Test_E2EHashService_ClassifyChangedHashAsPending() As String
    Dim p_Error As String
    Dim state As String
    p_Error = ""
