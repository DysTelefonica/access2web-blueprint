...
# CAP-004 — Cambio de tipo

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/lifecycle.md#requirement-exp-cap-004--cambio-de-tipo). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Cambio de tipo de expediente (AM, Lote, Basado de AM, Basado de Lote, individual, HPS); auditoría inmutable del cambio con actor/fecha; preservar invariantes de vinculaciones relacionadas; revertir archivo.
...
Previous: [capabilities-index](index.md) | Next: [CAP-005-estado-garantia](CAP-005-estado-garantia.md)
