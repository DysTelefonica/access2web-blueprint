...
# CAP-024 — Oficinas de programa

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/catalogs.md#requirement-exp-cap-024-oficinas-de-programa). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

CRUD master-detail para oficinas de programa vinculadas a ejército y orgánica; revertir archivo.
