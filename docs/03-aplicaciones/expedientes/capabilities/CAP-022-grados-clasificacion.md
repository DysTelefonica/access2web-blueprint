...
# CAP-022 — Grados de clasificación

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/catalogs.md#requirement-exp-cap-022-grados-de-clasificación). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

CRUD master-detail para grados de clasificación (reservado, confidencial, etc.); revertir archivo.
