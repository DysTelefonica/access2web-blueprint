...
# CAP-032 — Idempotencia y feedback

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/write-resilience.md#requirement-exp-cap-032-idempotencia-y-feedback). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Acciones repetidas no duplican; feedback al usuario de éxito/error; revertir archivo.
