...
# CAP-027 — Búsqueda técnica

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/query-and-tasks.md#requirement-exp-cap-027-búsqueda-técnica). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Vista técnica con campos específicos del expediente (sin lógica de negocio); revertir archivo.
