...
Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/e2e.md#requirement-exp-cap-037-paquete-e2e). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Paquete completo por expediente: DTO + anexos + hash; archivo ZIP; revertir archivo.
