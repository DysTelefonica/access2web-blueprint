...
# CAP-031 — Autosave relacionados

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/write-resilience.md#requirement-exp-cap-031-autosave-relacionados). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Autosave en subformularios (anexos, hitos, entidades); idempotente; revertir archivo.
