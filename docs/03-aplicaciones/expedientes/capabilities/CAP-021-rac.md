...
# CAP-021 — RAC (Responsable Acuerdo Contrato)

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/catalogs.md#requirement-exp-cap-021-rac). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

CRUD master-detail para responsables de acuerdo; revertir archivo.
