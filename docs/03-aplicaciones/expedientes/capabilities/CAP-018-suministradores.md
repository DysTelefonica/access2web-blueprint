...
# CAP-018 — Suministradores

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/catalogs.md#requirement-exp-cap-018-suministradores). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

CRUD master-detail de suministradores; catálogo, contratista/subcontratista, UTE; revertir archivo.
...
- D14: ver §Decisiones D-/DA- en [docs/architecture.md](../../../architecture.md).
