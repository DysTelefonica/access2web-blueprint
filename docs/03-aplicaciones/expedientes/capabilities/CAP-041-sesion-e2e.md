[← Back to capabilities-index](index.md) · [← Back to CAP-039-seleccion-manual](CAP-039-seleccion-manual.md)

# CAP-041 — Sesión E2E

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/e2e.md#requirement-exp-cap-041-sesión-e2e). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Aislamiento de sesión E2E: cada exportación batch opera en su propia sesión lógica; sin globals mutables compartidas entre batches concurrentes; auditoría de cada sesión; revertir archivo.
...
Previous: [CAP-039-seleccion-manual](CAP-039-seleccion-manual.md) | Next: [CAP-042-ordinal-e2e](CAP-042-ordinal-e2e.md)
