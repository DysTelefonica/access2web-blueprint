...
# CAP-038 — Trazabilidad E2E

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/e2e.md#requirement-exp-cap-038-trazabilidad-e2e). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

IDUsuarioCreacion/IDUsuarioUltimoCambio (Text 255) convertido a FK numérica real a users.id; revertir archivo.
