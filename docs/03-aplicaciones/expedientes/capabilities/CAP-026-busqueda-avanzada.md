...
# CAP-026 — Búsqueda avanzada

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/query-and-tasks.md#requirement-exp-cap-026-búsqueda-avanzada). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Filtros combinables por estado/código/JP/jurídica/suministrador; detalle solo lectura; revertir archivo.
...
- D70: ver §Decisiones D-/DA- en [docs/architecture.md](../../../architecture.md).
- D102: ver §Decisiones D-/DA- en [docs/architecture.md](../../../architecture.md).
