...
# CAP-028 — Exportación Excel

Capacidad de Expedientes. Resumen a nivel repo derivado del [spec fuente](../../../../openspec/changes/expedientes-web-migration/specs/query-and-tasks.md#requirement-exp-cap-028-exportación-excel). El spec contiene los escenarios G/W/T completos; este doc los resume y los vincula a las decisiones operativas vigentes.

## Escenario clave

Genera Excel con formato preservado del legacy; respeta filtros aplicados; revertir archivo.
...
- D16: ver §Decisiones D-/DA- en [docs/architecture.md](../../../architecture.md).
